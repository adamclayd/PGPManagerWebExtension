...
(function() {
	...
	tabs.directive('bs5Tabset', function() {
		return {
			...
			controllerAs: 'tabset',
			templateUrl: function(elm, attrs) {
				return attrs.templateUrl || (angular.isDefined(attrs.vertical) ? 'angular/bootstrap5/templates/tabs/tabset-vertical.html' : 'angular/bootstrap5/templates/tabs/tabset.html');
			},
			link: function(scope, elm, attrs) {
                if (angular.isDefined(attrs.vertical)) {
					if (!angular.isNumber(scope.verticalTabColWidth))
						scope.verticalTabColWidth = 2;

					else if (scope.verticalTabColWidth < 1)
						scope.verticalTabColWidth = 1;

					else if (scope.verticalTabColWidth > 11)
						scope.verticalTabColWidth = 11;
				}
			}
		}
	});
	...
	tabs.directive('bs5Tab', ['$parse', function($parse) {
		return {
			...
			templateUrl: function(elm, attrs) {
				return attrs.templateUrl || (angular.isDefined(elm.parent().attr('vertical')) ? 'angular/bootstrap5/templates/tabs/tab-vertical.html' : 'angular/bootstrap5/templates/tabs/tab.html');
			},
			controller: function() {},
			controllerAs: 'tab',
	...
	angular.module('angular/bootstrap5/templates/tabs/tabset.html', []).run(['$templateCache', function($templateCache) {
		$templateCache.put(
			...
			'<div class="bs5-tabset-horizontal">' +
				'<nav>' + 
					'<ul class="nav nav-tabs bs5-tabs mb-2" ng-transclude></ul>' +
				'</nav>' +
				'<div class="tab-content">' +
					'<div class="bs5-tab-pane-fade-in tab-pane bs5-tab-content" ng-repeat="tab in tabset.tabs" ng-class="{active: tabset.active === $index}" bs5-tab-content-transclude="tab"></div>' +
				'</div>' +
			'</div>'
		);
	}]);
	...
	angular.module('angular/bootstrap5/templates/tabs/tab.html', []).run(['$templateCache', function($templateCache) {
		$templateCache.put(
			'angular/bootstrap5/templates/tabs/tab.html',
			'<li class="nav-item">' +
				'<button class="nav-link text-nowrap bs5-tab" ng-disabled="disabled" ng-class="{active: active, disabled: disabled}" ng-click="select($event)" bs5-heading-transclude>{{heading}}</button>' +
			'</li>'
		)
	}]);

	angular.module('angular/bootstrap5/templates/tabs/tabset-vertical.html', []).run(['$templateCache', function($templateCache) {
		$templateCache.put(
			'angular/bootstrap5/templates/tabs/tabset-vertical.html',
			'<div class="row align-items-start bs5-tabset-vertical">' +
				'<div class="col-{{verticalTabColWidth}} nav flex-column nav-pills bs5-tabs" ng-transclude>' +
				'</div>' +
				'<div class="col-{{12 - verticalTabColWidth}} tab-content">' +
					'<div class="bs5-tab-pane-fade-in tab-pane bs5-tab-content" ng-repeat="tab in tabset.tabs" ng-class="{active: tabset.active === $index}" bs5-tab-content-transclude="tab"></div>' +
				'</div>' +
			'</div>'
		);
	...
	angular.module('angular/bootstrap5/templates/tabs/tab-vertical.html', []).run(['$templateCache', function($templateCache) {
		$templateCache.put(
			'angular/bootstrap5/templates/tabs/tab-vertical.html',
			'<button class="nav-link text-nowrap bs5-tab" ng-class="{active: active, disabled: disabled}" ng-disabled="disabled" ng-click="select($event)" bs5-heading-transclude>{{heading}}</button>'
		);
	}]);
	...
	angular.module('angular/bootstrap5/templates/pagination/pagination.html', []).run(['$templateCache', function($templateCache) {
		$templateCache.put(
			'angular/bootstrap5/templates/pagination/pagination.html',
			'<nav>' +
				'<ul class="pagination {{size === \'lg\' || size === \'sm\' ? \'pagination-\' + size : \'\'}}" ng-class="{\'text-center\': align === \'center\', \'text-end\': align === \'right\'}">' +
